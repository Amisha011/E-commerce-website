    ...
    return (
        ...
        {/* new arrivals section 2 */}
            <div className="sec1">
                ...
                <div className="books">
                    <div className="bsbooks">
                        <img src={newArrivalImg1}></img>
                        <h3>Rs.468</h3>
                        <p>The Copycat</p>
                        <span>Wendy McLeod Macknight</span>
                    </div>
                    <div className="bsbooks">
                        <img src={newArrivalImg2}></img>
                        <h3>Rs.929</h3>
                        <p>The Rose Code</p>
                        <span>Kate Quinn</span>
                    </div>
                    <div className="bsbooks">
                        <img src={newArrivalImg3}></img>
                        <h3>Rs.1,310</h3>
                        <p>The Fourth Child</p>
                        <span>Jessica Winter</span>
                    </div>
                    <div className="bsbooks">
                        <img src={newArrivalImg4}></img>
                        <h3>Rs.901</h3>
                        <p>The Bone Maker</p>
                        <span>Sarah Beth Durst</span>
                    </div>
                    <div className="bsbooks">
                        <img src={newArrivalImg5}></img>
                        <h3>Rs.1,407</h3>
                        <p>Foregone</p>
            ...
            <div className="sec1">
                ...
                <div className="authors">
                    <div className="Fauthors">
                        <img src={authorImg1}></img>
                        <p>GAYLE FORMAN</p>
                    </div>
                    <div className="Fauthors">
                        <img src={authorImg2}></img>
                        <p>ERICH SEGAL</p>
                       
                    </div>
                    <div className="Fauthors">
                        <img src={authorImg3}></img>
                     
                        <p>SYLVIA PLATH</p>
                    
                    </div>
                    <div className="Fauthors">
                        <img src={authorImg4}></img>
                        <p>SHASHI THAROOR</p>
                    </div>
                    <div className="Fauthors">
                        <img src={authorImg5}></img>
                        <p>GILLIAN FLYNN</p>
                    </div>
                    <i class="fas fa-chevron-right"></i>
                </div>
