                    ...
                    <div className="container-of-page">
                        ...
                        <div className="product-card">
                            ...
                            <div className="product-btns">
                                <button className="product-buy" onClick={() => buyNow(data._id)}><i class="fas fa-shopping-bag"></i>           Buy Now</button>
                                <button className="product-wishlist" onClick={() => wishList(data._id)}> <i class="far fa-heart"> </i>  Wishlist</button>
                            </div>
